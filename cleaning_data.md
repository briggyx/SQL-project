...
--After cleaning data, I saved the new tables, and reinserted them into the database
--The cleaned tables are in the folder 'ecommerce_dataset2.zip'
--The questions that I'll attempt to answer will use the newly cleaned tables
...
\copy all_sessions (full_visitor_id,channel_grouping,elapsed_time,country,city,page_views,purchase_date,visit_id,product_price,product_sku,v2_product_name,page_title,id) FROM '/Users/brigitte/desktop/ecommerce_dataset2/all_sessions.csv' DELIMITER ',' CSV HEADER;
...
\copy analytics (visit_number, visit_id, visit_start_time, purchase_date, full_visitor_id, unit_price, id) FROM '/Users/brigitte/desktop/ecommerce_dataset2/analytics.csv' DELIMITER ',' CSV HEADER;
...
ALTER TABLE products
RENAME COLUMN restocking_load_time TO restocking_lead_time;

\copy products (product_sku,product_name,ordered_quantity,stock_level,restocking_lead_time,sentiment_score,sentiment_magnitude) FROM '/Users/brigitte/desktop/ecommerce_dataset2/products.csv' DELIMITER ',' CSV HEADER;
...
\copy sales_by_sku (product_sku,total_ordered) FROM '/Users/brigitte/desktop/ecommerce_dataset2/sales_by_sku.csv' DELIMITER ',' CSV HEADER;
...
\copy sales_report (product_sku,total_ordered,product_name,stock_level,restocking_lead_time,sentiment_score,sentiment_magnitude) FROM '/Users/brigitte/desktop/ecommerce_dataset2/sales_report.csv' DELIMITER ',' CSV HEADER;
